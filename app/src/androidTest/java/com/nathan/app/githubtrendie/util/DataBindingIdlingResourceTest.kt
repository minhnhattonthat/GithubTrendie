...
class DataBindingIdlingResourceTest {
    ...
    class FakeBinding(view: View) :
        ViewDataBinding(mock<DataBindingComponent>(DataBindingComponent::class.java), view, 0) {
    ...
    private fun registerIdleCallback(): IdlingResource.ResourceCallback {
        val task = FutureTask<IdlingResource.ResourceCallback> {
            val callback =
                mock<IdlingResource.ResourceCallback>(IdlingResource.ResourceCallback::class.java)
